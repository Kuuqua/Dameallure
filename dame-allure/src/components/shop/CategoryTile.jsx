...
export default function CategoryTile({ category, href, label = "Shop now" }) {
  return (
    <Link href={href || `/shop/${category.slug}`} className="group block">
      <ProductImagePlaceholder seed={category.slug} keywords={category.imageKeywords} />
